...
# Generated on: Sun Apr 27 16:26:42 EEST 2025 (Sun Apr 27 13:26:42 UTC 2025)
...
set_log_file fv/fmultiplier/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/fmultiplier -revised fv_map
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  /home/mdaoudi/Documents/ic_project/fpu/synthesis/source/fmultiplier.v
elaborate_design -golden -root {fmultiplier} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/fmultiplier/fv_map.v.gz
elaborate_design -revised -root {fmultiplier}
...
#add_name_alias fv/fmultiplier/fv_map.singlebit.original_name.alias.json.gz -revised
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles fv/fmultiplier/rtl_to_fv_map.log
}
