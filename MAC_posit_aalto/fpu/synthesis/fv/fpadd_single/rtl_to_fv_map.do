...
# Generated on: Mon Apr 28 11:11:22 EEST 2025 (Mon Apr 28 08:11:22 UTC 2025)
...
set_log_file fv/fpadd_single/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/fpadd_single -revised fv_map
...
read_library -liberty -both /home/mdaoudi/Documents/ic_project/fpu/synthesis/flow/tech/lib/slow_vdd1v0_basicCells_hvt.lib
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  /home/mdaoudi/Documents/ic_project/fpu/synthesis/source/fp_normalizer.v /home/mdaoudi/Documents/ic_project/fpu/synthesis/source/fpadd_single.v
elaborate_design -golden -root {fpadd_single} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/fpadd_single/fv_map.v.gz
elaborate_design -revised -root {fpadd_single}
...
#add_name_alias fv/fpadd_single/fv_map.singlebit.original_name.alias.json.gz -revised
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles fv/fpadd_single/rtl_to_fv_map.log
}
