...
if [ ! -f "Pin1_16bit.txt" ] || [ ! -f "Pin2_16bit.txt" ]; then
...
vlog -work work posit_mult_16bit_tb.v posit_mult.v
...
vsim -c -do "run 1ms; quit" work.posit_mult_16bit_tb_v

# Verify simulation output
if [ ! -f "posit_results.txt" ]; then
