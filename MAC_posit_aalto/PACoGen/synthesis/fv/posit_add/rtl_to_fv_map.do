...
# Generated on: Sun Apr 27 14:48:37 EEST 2025 (Sun Apr 27 11:48:37 UTC 2025)
...
set_log_file fv/posit_add/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/posit_add -revised fv_map
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  /home/mdaoudi/Documents/ic_project/PACoGen/synthesis/source/posit_add.v
elaborate_design -golden -root {posit_add} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/posit_add/fv_map.v.gz
elaborate_design -revised -root {posit_add}
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles fv/posit_add/rtl_to_fv_map.log
}
