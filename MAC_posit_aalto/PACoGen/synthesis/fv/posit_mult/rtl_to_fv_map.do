...
# Generated on: Sun Apr 27 16:13:08 EEST 2025 (Sun Apr 27 13:13:08 UTC 2025)
...
set_log_file fv/posit_mult/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/posit_mult -revised fv_map
...
read_library -liberty -both /home/mdaoudi/Documents/ic_project/PACoGen/synthesis/flow/tech/lib/slow_vdd1v0_basicCells_hvt.lib
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  /home/mdaoudi/Documents/ic_project/PACoGen/synthesis/source/posit_mult.v
elaborate_design -golden -root {posit_mult} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/posit_mult/fv_map.v.gz
elaborate_design -revised -root {posit_mult}
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles fv/posit_mult/rtl_to_fv_map.log
}
